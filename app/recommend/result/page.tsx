...
import { UserInput, PriorityWeights, RecommendationResult } from "@/lib/types";
...
export default function ResultPage() {
  ...
  useEffect(() => {
    async function loadRecommendations() {
      ...
      const weightsStr = sessionStorage.getItem("priorityWeights");

      if (!userInputStr || !weightsStr) {
      ...
      try {
        ...
        const weights = JSON.parse(weightsStr) as PriorityWeights;

        const recommendations = await getRecommendations(userInput, weights);
