...
import { UserInput, PriorityOrder, RecommendationResult } from "@/lib/types";
  ...
  useEffect(() => {
    async function loadRecommendations() {
      ...
      try {
        ...
        if (userInput.recommendationType !== "body" || !userInput.priorityOrder) {
          router.push("/recommend/body/step1");
          return;
        }

        const recommendations = await getRecommendations(userInput, userInput.priorityOrder);
